...
class RobustGADriver(Driver):
    ...
    **kwargs : dict of keyword arguments
    ...
    def _declare_options(self):
        ...
        self.options.declare('patience', default=1, lower=1,
                                desc='Number of generations without improvement before stopping.')
        self.options.declare('tol', default=1e-3, lower=0.,
                             desc='Tolerance for convergence. The algorithm stops when the '
                             'difference between the best and worst objective values is less '
                             'than this value.')
